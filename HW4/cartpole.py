...
class Agent():
    ...
    def discretize_observation(self, observation):
        ...
        for i in range(len(observation)):
            discrete_value = self.discretize_value(observation[i], self.bins[i])
            state.append(discrete_value)
        return tuple(state)
        # End your code
    ...
    def choose_action(self, state):
        ...
        return np.argmax(self.qtable[tuple(state)]) # return the index of the highest Q-value
        # End your code
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        """
        # Begin your code
        # Get the Q value of the current state and next state
        ...
        self.qtable[state + (action,)] = (1 - self.learning_rate) * current_value + self.learning_rate * (reward + self.gamma * next_max)
        if done:
        # End your code
    ...
    def check_max_Q(self):
        ...
        initial_state = self.discretize_observation(self.env.reset())
    
        # Find the maximum Q-value for the initial state
        max_q = np.max(self.qtable[tuple(initial_state)])
        return max_q
        # End your code
