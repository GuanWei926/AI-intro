...
def main(args):
    ...
    detection.detect('C:/Users/Microsoft/Desktop/HW1/HW1/data/detect/detectData.txt', clf)

    # Part 5: Test classifier on your own images
    print('\nDetect faces on your own images')
    detection.detect('C:/Users/Microsoft/Desktop/HW1/HW1/data/your_own_image/detectImage.txt', clf)
